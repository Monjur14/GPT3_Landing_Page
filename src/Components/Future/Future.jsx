  ...
  return (
    <div className='future' id='aboutus'>
      ...
      <div className="right__content">
            <div className="inner__right_content">
                <SubTitle title="Improving end distrusts instantly "/>
            ...
            <div className="inner__right_content">
                <SubTitle title="Become the tended active"/>
